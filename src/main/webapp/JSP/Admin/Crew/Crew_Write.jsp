...
// List형 객체 crews 선언하고 request 객체에서 crews키의 값을 저장
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div id="container_wrapper">
			<main id="container">
				<div class="inner">
					...
					<div class="contents">
						<div class="inner">
							<form name="writeFrm" method="post" action="/JSP/Admin/Crew/Crew_WriteProcess.adcr">
								<table border="1" width="80%">
									...
									<tr>
										<td>LOCATION_ID</td>
										<td><input type="text" name="location_id" style="width: 90%;" />
										</td>
									</tr>
									<tr>
										<td>DESCRIPTION</td>
										<td><input type="text" name="description" style="width: 90%;" />
										</td>
									</tr>
									<tr>
										<td colspan="2" align="center">
											...
											<button type="button" onclick="location.href='/JSP/Admin/Crew/Crew_List.adcr';">
											목록 보기
											</button>
										</td>
									</tr>
