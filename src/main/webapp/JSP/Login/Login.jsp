...
<main id="main_info">
	...
	<div id="inner">
		...
		<form action="LoginProcess.lo" method = "post" name = "LoginFrm" onsubmit="return validateForm(this)">
			<label for="user_id" style="display: flex;">ID</label>  <input type="text" name="user_id" id="user_id" class="input-field"> 
			<label for="user_pw" style="display: flex;">PW</label>  <input type="password" name="user_pw" id="user_pw" class="input-field">
