      ...
      <section class="contents">
        <div class="inner">
          <div class="board_write">
            <form name="writeFrm" method="post" action="Cs_WriteProcess.co" onsubmit="return validateForm(this);">
              <fieldset>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                  <label class="radio"><input type="radio" name="category" value="cs" checked>모임개설하기</label>
                  <label class="radio"><input type="radio" name="category" value="cv">모임참가하기</label>
                  <label class="radio"><input type="radio" name="category" value="cl">기타</label>
                    </td>
                  </tr>
               <tr>
                    <th>공개여부 <i class="star"></i></th>
                    <td>
                       <label class="radio"><input type="radio" name="ableview" value="공개" checked> 공개</label>
                  <label class="radio"><input type="radio" name="ableview" value="비공개"> 비공개</label>
                      </td>
                  </tr>
                  <tr>
